...
You should read through it carefully.  In most cases, you'll just be asked to run pre-written lines of code.  But there are some places where I've identified **Tasks**, which will require you to write some code and run it. 
...
**Task One**: create a new code block below this paragraph.  Put in a comment that says "I am printing out my name." Then write a print function that prints out your name and execute it.  Be sure to put your name in single quotes, or you'll get an error.   
...
We're going to learn to do most of those same things here today. 
